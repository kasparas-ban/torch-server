INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `priority`) VALUES (1, '1ax1usfu2uku', 'Learn Spanish', 'DREAM', 'HIGH');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`) VALUES (1, '2ax1usfu2uku', 'Get fit', 'DREAM');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`) VALUES (1, '3ax1usfu2uku', 'Get good at math', 'DREAM');

INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `target_date`, `priority`) VALUES (1, '4bax1usfu2uk', 'Make a todo/timer app', 'GOAL', '2023-12-01', 'HIGH');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `priority`) VALUES (1, '5bax1usfu2uk', 'Learn chess', 'GOAL', 'LOW');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `parent_id`) VALUES (1, '6bax1usfu2uk', 'Learn Spanish vocabulary', 'GOAL', '1ax1usfu2uku');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `parent_id`) VALUES (1, '7bax1usfu2uk', 'Learn Spanish grammar', 'GOAL', '1ax1usfu2uku');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `parent_id`) VALUES (1, '8bax1usfu2uk', 'Spanish language comprehension', 'GOAL', '1ax1usfu2uku');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `parent_id`) VALUES (1, '9bax1usfu2uk', 'Spanish writing', 'GOAL', '1ax1usfu2uku');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `parent_id`) VALUES (1, '10ax1usfu2uk', 'Build muscle', 'GOAL', '2ax1usfu2uku');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `parent_id`, `target_date`) VALUES (1, '11ax1usfu2uk', 'Learn Linear Algebra', 'GOAL', '3ax1usfu2uku', '2023-12-01');
INSERT INTO `items` (`user_id`, `public_item_id`, `title`, `type`, `parent_id`) VALUES (1, '12ax1usfu2uk', 'Learn Calculus', 'GOAL', '3ax1usfu2uku');
